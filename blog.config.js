...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '落日归山海，山海藏深意。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'pusen.love', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'PUSEN, 浦深', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lu@pusen.love', // 邮箱地址 例如mail@tangly1024.com
